...
import org.samples.keyboardmanager.addons.AddOnsFactory;
import org.samples.keyboardmanager.utils.Logger;
...
public class KeyboardFactory extends AddOnsFactory<KeyboardAddOnAndBuilder> {
    ...
    private static final String XML_KEYBOARD_DESCRIPTION_ATTRIBUTE = "description";

    public KeyboardFactory() {
        super(TAG, "org.samples.langpack.KEYBOARD", "org.samples.leankey.langpack.keyboards",
                "Keyboards", "Keyboard",
                0, true);
    }

    public KeyboardFactory(String receiverAction, String receiverMetaData) {
        super(TAG, receiverAction, receiverMetaData, "Keyboards", "Keyboard", 0, true);
    }
    ...
    protected KeyboardAddOnAndBuilder createConcreteAddOn(Context askContext, Context context, String prefId, int nameId, String description, int sortIndex, AttributeSet attrs) {
        ...
        final String keyboardDescription = attrs.getAttributeValue(null, XML_KEYBOARD_DESCRIPTION_ATTRIBUTE);
        ...
        if ((prefId == null) || (nameId == AddOn.INVALID_RES_ID) || (layoutResId == AddOn.INVALID_RES_ID)) {
            ...
            return new KeyboardAddOnAndBuilder(askContext, context,
                    ...
                    defaultDictionary, keyboardDescription, iconResId, physicalTranslationResId,
